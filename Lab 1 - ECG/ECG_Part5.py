...
# A Butterworth bandpass filter set to keep frequencies of  0.5–40 Hz
...
fourier_data = scipy.fft.fft([times,filtered_data])

# Plot the final graph
fig, ax = plt.subplots(1,2)
ax[0].plot(times, filtered_data, linewidth=2, label="Filtered ECG Signal")   # plot signal data with a label                                                                                                   
ax[0].plot(times[peaks], filtered_data[peaks], 'rx', label="Detected Peaks") # plots points at times and heights indexed by [peaks]. rx stands for red x (marker colour and shape)                             
ax[0].set_xlabel('Time (seconds)')                                           # label the x axis                                                                                                                
ax[0].set_ylabel('Voltage (V)')                                              # label the y axis                                                                                                                
ax[0].set_title('ECG Signal with Detected Peaks')                            # title the graph                                                                                                                 
ax[0].legend(loc="best")                                                     # 1 is top right, 2 is top left, 3 is bottom right, 4 is bottom left. You can also spell out locations (eg. "center left"). https: // matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.legend.html
ax[0].grid(True)                                                             # show a grid background                                                                                                          

ax[1].plot(fourier_data[0],fourier_data[1], linewidth=2, label="Fourier")    # plot signal data with a label                                                                                                   
ax[1].set_xlabel('frequency')                                                # label the x axis                                                                                                                
ax[1].set_ylabel('Magnitude')                                                # label the y axis                                                                                                                
ax[1].set_title('frequenncy')                                                # title the graph                                                                                                                 
ax[1].legend(loc="best")                                                     # 1 is top right, 2 is top left, 3 is bottom right, 4 is bottom left. You can also spell out locations (eg. "center left"). https: // matplotlib.org/stable/api/_as_gen/matplotlib.pyplot.legend.html
ax[1].grid(True)                                                             # show a grid background                                                                                                          
fig.tight_layout()                                                          
