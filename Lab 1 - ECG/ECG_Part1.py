...
from nidaqmx.constants import AcquisitionType, TerminalConfiguration # import some constants from nidaqmx (try print(AcquisitionType.FINITE.value) to see what value is stored inside of the
#                                                                      AquisitionType.FINITE variable). Also, these are both variable called enums, which can only take specific values and are kind of weird.
